...
public:
    void LaneDetector::myDetector(Mat frame); //qt检测算法运行模块
    ...
    bool streetSign(Mat img_original);//路牌检测
    ...
    void plotLane(Mat inputImage, vector<Point> lane);  //绘制合成车道并在框架中进行转弯预测。
};
